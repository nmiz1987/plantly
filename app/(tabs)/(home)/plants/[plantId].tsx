  ...
  return (
    <View style={styles.detailsContainer}>
      <View style={{ alignItems: 'center' }}>
        ...
        <Text style={styles.value}>{plant.lastWateredAtTimestamp ? `${format(plant.lastWateredAtTimestamp, fullDateFormat)}` : 'Never 😟'}</Text>
        <Text style={styles.key}>Days since last watered</Text>
        <Text style={styles.value}>{plant.lastWateredAtTimestamp ? differenceInCalendarDays(Date.now(), plant.lastWateredAtTimestamp) : 'N/A'}</Text>
      </View>
